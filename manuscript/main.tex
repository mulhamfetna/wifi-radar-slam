...
%% ===========================================================================
%% AUTHOR BIOGRAPHY
%% To use the photo version: place a headshot at figures/author-photo.jpg, then comment out
%% the \IEEEbiographynophoto block below and uncomment the \IEEEbiography block.
%% NOTE: the bracketed fields are placeholders -- fill in before submission.
%
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author-photo.jpg}}]{Mulham Fetna}
% received the [DEGREE] degree in [FIELD] from [INSTITUTION], [CITY, COUNTRY], in [YEAR].
% He is currently a [ROLE] with [AFFILIATION]. His research interests include robotics and
% mechatronics, wireless sensing with commodity WiFi channel state information, simultaneous
% localization and mapping, and low-cost RF sensing hardware. He advocates open, reproducible
% research: the code, data, and hardware designs supporting this work are released publicly under
% a copyleft licence and archived with persistent DOIs. (ORCID 0009-0006-4432-798X.)
% \end{IEEEbiography}

\begin{IEEEbiographynophoto}{Mulham Fetna}
received the [DEGREE] degree in [FIELD] from [INSTITUTION], [CITY, COUNTRY], in [YEAR]. He is
currently a [ROLE] with [AFFILIATION]. His research interests include robotics and mechatronics,
wireless sensing with commodity WiFi channel state information, simultaneous localization and
mapping, and low-cost RF sensing hardware. He advocates open, reproducible research: the code,
data, and hardware designs supporting this work are released publicly under a copyleft licence and
archived with persistent DOIs. (ORCID 0009-0006-4432-798X.)
