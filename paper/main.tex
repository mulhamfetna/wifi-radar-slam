...
are gated out alongside the phantoms. A robust discriminator that does not rely on
unbiased delays---e.g.\ a learned LOS/reflection classifier on CSI features---remains
open.

% ============================================================================
\section{Future Work}
% ============================================================================
Three directions follow directly. \emph{(i) Path discrimination}---the identified
mapping bottleneck---calls for a learned or feature-based classifier that labels a
CSI component as line-of-sight, single reflection, or multi-bounce without relying
on unbiased delays. \emph{(ii) An outdoor, vehicle-mounted WiFi-CSI dataset}: our
real-CSI proof-of-concept is limited to indoor static captures because no public
outdoor/vehicular CSI exists; collecting one is a contribution in itself and the
prerequisite for full-system validation. \emph{(iii)} Tighter integration with a
