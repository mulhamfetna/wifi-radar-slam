...
CSI, which we identify as the key open problem. Approaches that could close it
(learned path classification, physical bounce-count features, multi-pass geometric
consistency) are left to future work. Localization, which does not require this
